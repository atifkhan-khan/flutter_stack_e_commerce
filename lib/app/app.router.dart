...
import 'package:flutter_stack_e_comerce/ui/views/home/home_view.dart' as _i2;
...
class Routes {
  ...
  static const uIDesignView = '/u-idesign-view';
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.UIDesignView: (data) {
      return _i6.MaterialPageRoute<dynamic>(
        builder: (context) => const _i4.UIDesignView(),
        settings: data,
      );
    },
    _i5.ProductDetailsView: (data) {
      return _i6.MaterialPageRoute<dynamic>(
        builder: (context) => const _i5.ProductDetailsView(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i7.NavigationService {
  ...
  Future<dynamic> navigateToUIDesignView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.uIDesignView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithUIDesignView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.uIDesignView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
